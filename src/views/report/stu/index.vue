...
import { queryStudentClazzDataApi, queryStudentGenderDataApi } from '@/api/reportStudent'
...
const loadClazzChart = async () => {
  let result = await queryStudentClazzDataApi();
...
const loadGenderChart = async () => {
  let result = await queryStudentGenderDataApi();
